...
using namespace std;
typedef struct Costs{                           //la struttura Costs mi serve per salvare una porzione di dati da ordinare in base al costo e trovare un così un minimo locale con appriocio greedy
        double costo;
        int i;
        int j;
        int m;
...
public:
    ...
    void quicksort(Costs **A, int len);
